...
class ExtendedOutdatedCommand extends BaseCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        // fake setup to act as outdated - TODO remove code and options which we will not use
        $input->setOption('outdated', true);
        // end of fake setup
...
//                        }
        ...
        if ('json' === $format) {
            ...
            $packages = array_merge(...array_values($viewData));
     ...
     */
    private function getVersionStyle(PackageInterface $latestPackage, PackageInterface $package)
    {
     ...
     */
    private function getPackage(InstalledRepository $installedRepo, RepositoryInterface $repos, string $name, $version = null)
    {
     ...
     * @return void
     */
    private function printPackageInfo(CompletePackageInterface $package, array $versions, InstalledRepository $installedRepo, PackageInterface $latestPackage = null)
    {
        $io = $this->getIO();
     ...
     * @return void
     */
    private function printMeta(CompletePackageInterface $package, array $versions, InstalledRepository $installedRepo, PackageInterface $latestPackage = null)
    {
        $io = $this->getIO();
     ...
     * @return void
     */
    private function printVersions(CompletePackageInterface $package, array $versions, InstalledRepository $installedRepo)
    {
     ...
     * @return void
     */
    private function printLinks(CompletePackageInterface $package, $linkType, $title = null)
    {
     ...
     * @return void
     */
    private function printLicenses(CompletePackageInterface $package)
    {
     ...
     * @return void
     */
    private function printPackageInfoAsJson(CompletePackageInterface $package, array $versions, InstalledRepository $installedRepo, PackageInterface $latestPackage = null)
    {
        $json = array(
     ...
     * @return void
     */
    private function displayPackageTree(array $arrayTree)
    {
        $io = $this->getIO();
     ...
     */
    private function generatePackageTree(
